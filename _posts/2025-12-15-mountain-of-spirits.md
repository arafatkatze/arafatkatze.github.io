...
I'm not a woo-woo person. I don't really believe in spirits or mysticism in general. I walked into a hostel here in Mont tremblant and it read that the ancient Algonquin tribe called this place _Manitonga Soutana,_ "The Mountain of Spirits."

<div class="col-sm mt-3 mt-md-0 mx-auto" style="max-width: 520px;">
      {% include figure.html
     path="https://res.cloudinary.com/dozxd4znm/image/upload/q_auto,f_auto/v1766712820/manitonga_ukgdy8.png"
     title="example image"
...
<div class="col-sm mt-3 mt-md-0 mx-auto" style="max-width: 520px;">
    {% include figure.html path="https://res.cloudinary.com/dozxd4znm/image/upload/v1766713078/sunlight-min_moztiz.png" title="example image" class="img-fluid rounded z-depth-1" %}
</div>
...
<div class="col-sm mt-3 mt-md-0 mx-auto" style="max-width: 520px;">
    {% include figure.html path="https://res.cloudinary.com/dozxd4znm/image/upload/q_auto,f_auto/v1766713080/chateau-min_ytomax.png" title="example image" class="img-fluid rounded z-depth-1" %}
</div>

Maybe I didn't learn anything here. Maybe that's the point.

All this rumination, trying to figure out what it _means_, what I should _take away_ it's counterproductive. When you're really in love with something, it pulls you so fucking hard you forget who you are. You stop asking what you're learning. You stop asking anything.
...
<div class="col-sm mt-3 mt-md-0 mx-auto" style="max-width: 520px;">
      {% include figure.html
     path="https://res.cloudinary.com/dozxd4znm/image/upload/q_auto,f_auto/v1766712478/tearhappy_wey27v.png" 
     title="example image"
     class="img-fluid rounded z-depth-1"
     max_width="50px" %}
</div>
