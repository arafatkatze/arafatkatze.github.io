...
<form id="guestbook-form" class="guestbook-form" autocomplete="off">
  ...
  <input id="gb-name" name="name" class="guestbook-input guestbook-input--name"
    type="text" maxlength="32" placeholder="Name or initials" required />
  <label for="gb-msg" class="sr-only">A single line</label>
  <input id="gb-msg" name="msg" class="guestbook-input guestbook-input--msg"
    type="text" maxlength="180" placeholder="A single line — what's on your mind?" required />
